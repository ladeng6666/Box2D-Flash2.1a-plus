...
*/
/**
 * added MulQV() and MulTQV() by Dony.ladeng6666 2014-08-30 
 */
...
public class b2Math{
	...
	*/
	 ...
	 * C++ command
	 * inline float32 b2Cross(const b2Vec2& a, float32 s)
	 */
	...
	/**
	 * Perform the cross product on a scalar and a vector. In 2D this produces a vector. <br>
	 * C++ command <br>
	 ...
	 * 
	 */	
	static public function MulQV(q:b2Rot, v:b2Vec2):b2Vec2
	{
	 ...
	 * 
	 */	
	static public function MulTQV(q:b2Rot, v:b2Vec2):b2Vec2
	{
		return new b2Vec2(q.c * v.x + q.s * v.y, -q.s * v.x + q.c * v.y);
	}
	...
	static public function Mul22(A:b2Mat33, v:b2Vec2):b2Vec2
	{
		return new b2Vec2(A.col1.x * v.x + A.col2.x * v.y, A.col1.y * v.x + A.col2.y * v.y);
	}
	/// Multiply a matrix times a vector.
	static public function Mul33(A:b2Mat33, v:b2Vec3):b2Vec3
	{
		var v3:b2Vec3 = MulFV3(v.x,A.col1);
		v3.Add(MulFV3(v.y,A.col2));
		v3.Add(MulFV3(v.z,A.col3));
		return v3;
//		return v.x * A.ex + v.y * A.ey + v.z * A.ez;
	}

	static public function MulFV3(f:Number,v:b2Vec3):b2Vec3{
		return new b2Vec3(f*v.x,f*v.y,f*v.z);
	}
