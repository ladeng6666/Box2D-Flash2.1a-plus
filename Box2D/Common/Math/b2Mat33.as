...
public class b2Mat33
{
	...
	public function GetInverse22(M:b2Mat33):b2Mat33
	{
		...
		M.col1.x =  det * d;	M.col2.x = -det * b; M.col1.z = 0.0;
		M.col1.y = -det * c;	M.col2.y =  det * a; M.col2.z = 0.0;
		M.col3.x = 0.0; M.col3.y = 0.0; M.col3.z = 0.0;
		return M;
	}
	public function GetSymInverse33(M:b2Mat33):b2Mat33
	{
		var det:Number = b2Dot(col1, b2Cross(col2, col3));
		if (det != 0.0)
		{
			det = 1.0 / det;
		}
		
		var a11:Number = col1.x, a12:Number = col2.x, a13:Number = col3.x;
		var a22:Number = col2.y, a23:Number = col3.y;
		var a33:Number = col3.z;
		
		M.col1.x = det * (a22 * a33 - a23 * a23);
		M.col1.y = det * (a13 * a23 - a12 * a33);
		M.col1.z = det * (a12 * a23 - a13 * a22);
		
		M.col2.x = M.col1.y;
		M.col2.y = det * (a11 * a33 - a13 * a13);
		M.col2.z = det * (a13 * a12 - a11 * a23);
		
		M.col3.x = M.col1.z;
		M.col3.y = M.col2.z;
		M.col3.z = det * (a11 * a22 - a12 * a12);
		return M;
	}
	private function b2Cross(a:b2Vec3, b:b2Vec3):b2Vec3
	{
		return new b2Vec3(a.y * b.z - a.z * b.y, a.z * b.x - a.x * b.z, a.x * b.y - a.y * b.x);
	}
	private function b2Dot(a:b2Vec3, b:b2Vec3):Number
	{
