...
/**
 * 2014-09-06 Adding APIs below according to Box2D 2.3.0 of C++
...
public class b2PulleyJoint extends b2Joint
{
	...
	/**
	 * Get the length of the segment attached to bodyA.
	 */
	...
	/**
	 * Get the length of the segment attached to bodyB.
	 */
	...
	/**
	 * Get the current length between anchorA and groundAnchorA.
	 */
	...
	/**
	 * Get the current length between anchorB and groundAnchorB.
	 */
...
//		trace(m_maxLength1*30,m_maxLength2*30);
	}
	...
	// ladeng6666 2014-08-29
	private var m_lengthA:Number;
	private var m_lengthB:Number;
	// static
