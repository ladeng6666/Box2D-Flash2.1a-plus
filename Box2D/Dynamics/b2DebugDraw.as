...
public class b2DebugDraw
{
	...
	*/
	 ...
	 * Draw a circle.
	 */
	public virtual function DrawPoint(center:b2Vec2, size:Number, color:b2Color) : void{
		
		m_sprite.graphics.lineStyle(m_lineThickness, color.color, m_alpha);
		m_sprite.graphics.beginFill(color.color,m_fillAlpha);
		m_sprite.graphics.drawCircle(center.x * m_drawScale, center.y * m_drawScale, size * m_drawScale);
	...
	*/
	...
	public virtual function DrawAABB(aabb:b2AABB,color:b2Color):void{
		m_sprite.graphics.lineStyle(m_lineThickness,color.color,m_alpha);
		m_sprite.graphics.moveTo(aabb.lowerBound.x*m_drawScale,aabb.lowerBound.y*m_drawScale);
		m_sprite.graphics.lineTo(aabb.upperBound.x*m_drawScale,aabb.lowerBound.y*m_drawScale);
		m_sprite.graphics.lineTo(aabb.upperBound.x*m_drawScale,aabb.upperBound.y*m_drawScale);
		m_sprite.graphics.lineTo(aabb.lowerBound.x*m_drawScale,aabb.upperBound.y*m_drawScale);
		m_sprite.graphics.lineTo(aabb.lowerBound.x*m_drawScale,aabb.lowerBound.y*m_drawScale);
	}
