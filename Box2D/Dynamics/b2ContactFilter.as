...
public class b2ContactFilter
{
	...
	*/
	public virtual function ShouldCollide(fixtureA:b2Fixture, fixtureB:b2Fixture) : Boolean{
		...
		var shape1:b2Shape = fixtureA.GetShape();
		var shape2:b2Shape = fixtureB.GetShape();
		//---------------------------------
		// added by ladeng6666 2014-09-16
		// to prevent edge polygon collide
		if(shape1.GetType() ==1 && shape2.GetType()==1){
			if((shape1 as b2PolygonShape).GetVertexCount()==2 && (shape2 as b2PolygonShape).GetVertexCount()==2) return false;
		}
		//---------------------------------
