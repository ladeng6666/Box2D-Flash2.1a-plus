...
public class b2Contact
{
	...
	*/
	...
	//--------------- below is added by Dony.ladeng6666-------
	/**
	 * Set the tangent speed on contacted surface
	 */	
	...
	public function ResetFriction():void{
		m_friction = b2Settings.b2MixFriction(m_fixtureA.m_friction,m_fixtureB.m_friction);
	}
	...
	public function ResetRestitution():void{
		m_restitution = b2Settings.b2MixRestitution(m_fixtureA.m_restitution,m_fixtureB.m_restitution);
	}
	//--------------- Internals Below -------------------
