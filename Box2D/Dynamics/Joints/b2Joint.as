...
//Added support for b2MotorJoint and b2WheelJoint - Dony.ladeng6666 @http://www.ladeng6666.com
//swith enum b2JointType and b2LimitState to public from b2internal - Dony.ladeng6666 @http://www.ladeng6666.com
...
public class b2Joint
{
	...
	*/
	...
	/**
	 * Get the two bodies attached on joint collide with each other or not
	 * added by Dony.ladeng6666 2014-09-02
	 * 
	 */	
	...
	static b2internal function Create(def:b2JointDef, allocator:*):b2Joint{
		...
		case e_motorJoint:
		{
			joint = new b2MotorJoint(def as b2MotorJointDef);
		}
			break;
		default:
		...
		if (def.type == e_wheelJoint) 
		{
			joint = new b2WheelJoint(def as b2WheelJointDef);
		}
		return joint;
	}
	...
	static public const e_wheelJoint:int =13;
	static public const e_motorJoint:int =12;
	// enum b2LimitState
